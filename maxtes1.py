...
settings = {
    ...
    "dblack": False,
    "clock": False,
    "cName":"【さัএπัஞ✵ບิथℓℓҨतΩ】",
    "cNames":"【さัএπัஞ✵ບิथℓℓҨतΩ】",
    "welcome":"ยินดีต้อนรับ นะครับคนสวย 😂",
    "bye":"ไปเรย ชิ้ว 😔",
    "invite": {},
    "winvite": False,
    "pnharfbot": {},
...
def myhelp():
    myHelp =      " 🛡 คำสั่ง  💨 เรียกดูคำสั่ง😶"+ "  \n" + \
                  ...
                  " 🛡 Spam  on +เลข+ข้อความ▥  ➾ "+ "  \n" + \
                  " 🛡 cb  💨 ล้างบชดำ™"+ "  \n" + \
                  " 🛡 Rakey 💨 สั่งคลิ้กเข้า立"+ "  \n" + \
                  " 🛡 1-3 @  💨 สั่งคลิ้กเตะ🎿"+ "  \n" + \
                  " 🛡 Cleanse  💨 สั่งคลิ้กบิน🎴"+ "  \n" + \
                  " 🛡 เปิดกัน  💨 เปิดป้องกัน🎲"+ "  \n" + \
                  " 🛡 ปิดกัน 💨 ปิดป้องกัน🎍"+ "  \n" + \
                  " 🛡 เปิดกันยก 💨 เปิดยกเลิกป้องกัน🎐"+ "  \n" + \
                  " 🛡 ปิดกันยก 💨 ปิดยกเลิกป้องกัน🏡"+ "  \n" + \
                  " 🛡 เปิดกันเชิญ 💨 เปิดเชิญป้องกัน🌐"+ "  \n" + \
                  " 🛡 ปิดกันเชิญ  💨 ปิดเชิญป้องกัน🏦"+ "  \n" + \
                  " 🛡 เปิดกันลิ้ง 💨 เปิดป้องกันลิ้งค์🏩"+ "  \n" + \
                  " 🛡 ปิดกันลิ้ง 💨 ปิดป้องกันลิ้งค์🌇"+ "  \n" + \
                  " 🛡 เปิดกันสมาชิก 💨 เปิดป้องกันสมาชิก🚅"+ "  \n" + \
                  " 🛡 ปิดกันสมาชิก 💨 ปิดป้องกันสมาชิก⌛"+ "  \n" + \
                  " 🛡 เปิดกันคนเข้า 💨 เปิดป้องกันคนเข้า🌜"+ "  \n" + \
                  " 🛡 ปิดกันคนเข้า  💨 ปิดป้องกันคนเข้า⛅"+ "  \n" + \
                  "By.【さัএπัஞ✵ບิथℓℓҨतΩ】"
    return myHelp
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "กรุณาล็อคอินลิ้งค์ใหม่ด้วยครับ")
...
#==============================================================================#
                    ...
                    try:
                        ...
                        if settings["autoLeave"] == True: ret_ += "\ออกแชทรวมออโต้ 🔵"
                        else: ret_ += "\nออกแชทรวมออโต้ 🔴"
...
#===================================================================#              
                    ...
                    line.sendMessage(msg.to,"【さัএπัஞ✵ບิथℓℓҨतΩ】")
                  ...
                  if msg._from in admin:
                    ...
                    elapsed_time = time.time() - start
                    line.sendMessage(to, "ลบแล้วจร้า")
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งคนเข้า")
                     else:
                          settings["Sd"] = spl
                          line.sendMessage(msg.to, "{}".format(str(spl)))
